...
import com.kit.imagelib.interfaces.ImageLoadingListener;
import com.kit.imagelib.interfaces.ImageLoadingProgressListener;
import com.kit.imagelib.tools.ImageLoader;
...
//        LogUtils.i(ImagesLookerPhotoViewFragment.class, "rpb:" + rpb);
...
//        String thumbnail_pic_dir = ImageLoader.getInstance().getDiskCache().get(thumbnail_pic).getPath();
    ...
    public void loadImg() {
        ...
        if (isLoaded(useUrl)) {//如果本地缓存有，就从本地缓存加载
            ...
            ImageLoader.getInstance().loadImage(useUrl, new ImageLoadingListener() {
...
//                    rpb.setVisibility(View.GONE);
                ...
                public void onLoadingComplete(String s, View view, Bitmap bitmap) {
                    if (isLoaded(s)) {
                        ...
                        ImageLibUitls.deleteFile(ImageLoader.getInstance().getCacheImage(s));
...
//                    Log.e("APP", "progress:" + bee + " current:" + current + " total:" + total);
    ...
    private void showImage(String url) {
        ...
        if (imageView instanceof PhotoView) {
            ...
            ImageLoader.getInstance().display(imageView, "file://" + filedir);
